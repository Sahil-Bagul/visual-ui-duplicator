          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="flex-1 order-2 md:order-1">
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  <PaymentOption id="upi" title="UPI / QR" subtitle="Pay via UPI Apps like GPay, PhonePe, Paytm" selected={selectedPayment === 'upi'} onChange={() => setSelectedPayment('upi')} />
                  
                  <PaymentOption id="card" title="Credit / Debit Card" subtitle="All major cards accepted" selected={selectedPayment === 'card'} onChange={() => setSelectedPayment('card')} />
                  
                  <PaymentOption id="netbanking" title="Net Banking" subtitle="All Indian banks supported" selected={selectedPayment === 'netbanking'} onChange={() => setSelectedPayment('netbanking')} />
                </div>
              </div>
              
              {isRazorpayLoaded ? <Button onClick={handlePayment} disabled={isProcessing} className="w-full bg-[#00C853] hover:bg-[#00B248] text-white mt-4 py-6 text-lg">
                  {isProcessing ? <>
                      <Loader2 className="mr-2 h-5 w-5 animate-spin" />
                      Processing...
                    </> : `Pay ₹${coursePrice}`}
                </Button> : <Button onClick={handleSimulatedPayment} disabled={isProcessing} className="w-full bg-[#00C853] hover:bg-[#00B248] text-white mt-4 py-6 text-lg">
                  {isProcessing ? <>
                      <Loader2 className="mr-2 h-5 w-5 animate-spin" />
                      Processing...
              ...
              {!isRazorpayLoaded && <div className="mt-4 bg-yellow-50 p-3 rounded-md text-sm">
            ...
            <div className="flex-1 order-1 md:order-2">
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
                ...
                {referralCode && <div className="bg-blue-50 p-2 rounded text-sm mb-3">
                ...
                <div className="mt-4 bg-yellow-50 p-3 rounded-lg">
                  <p className="text-sm text-yellow-800">After successful payment, you'll get immediate access to the course and your own referral code.</p>
                </div>
              </div>
            </div>
          </div>
